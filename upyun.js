 ...
 * return null
 */
UPYUN.config = function (bucketname, username, password) {
    _bucketname = bucketname;
    _username = username;
    _password = md5(password);
}

UPYUN.version = function(){
    return '1.0.1';
}
 ...
 * return null;
 */
UPYUN.setApiDomain = function (domain) {
    _apiDomain = domain;
}
 ...
 * return null;
 */
UPYUN.setContentMD5 = function(str){
    _contentMD5 = str;
}
...
* return null;
*/
UPYUN.setFileSecret = function(str){
  _fileSecret = str;
}
...
*/
UPYUN.getFileInfo = function(file, callback){
...
*/
UPYUN.getWritedFileInfo = function(key){
 ...
 * @param callback 回调函数
 */
UPYUN.getBucketUsage = function(callback){
 ...
 * @param callback 回调函数
 */
UPYUN.getFolderUsage = function (path, callback){
 ...
 */
UPYUN.writeFile = function (file, data, autoMkdir, callback, opts){
...
* return 文件内容 或 null
*/
UPYUN.readFile = function (file, output_file, callback) {
...
*/
UPYUN.deleteFile = function (file, callback){
...
*/
UPYUN.mkDir = function (path, autoMkdir, callback) {
    _autoMkdir = autoMkdir;
...
* @param path 目录路径
*/
UPYUN.rmDir = function (path, callback){
...
* @param path 目录路径
*/
UPYUN.readDir = function (path, callback){
